...
sips -z 16 16 "$NORMALIZED_ICON" --out "$ICONSET_DIR/icon_16x16.png"
sips -z 32 32 "$NORMALIZED_ICON" --out "$ICONSET_DIR/icon_16x16@2x.png"
sips -z 32 32 "$NORMALIZED_ICON" --out "$ICONSET_DIR/icon_32x32.png"
sips -z 64 64 "$NORMALIZED_ICON" --out "$ICONSET_DIR/icon_32x32@2x.png"
sips -z 128 128 "$NORMALIZED_ICON" --out "$ICONSET_DIR/icon_128x128.png"
sips -z 256 256 "$NORMALIZED_ICON" --out "$ICONSET_DIR/icon_128x128@2x.png"
sips -z 256 256 "$NORMALIZED_ICON" --out "$ICONSET_DIR/icon_256x256.png"
sips -z 512 512 "$NORMALIZED_ICON" --out "$ICONSET_DIR/icon_256x256@2x.png"
